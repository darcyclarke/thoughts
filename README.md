...
So the next time someone asks you whether `x` is a **"function"** or **"method"**, feel free to explain *how pedantically incorrect that sentiment is* (you cheeky developer you).
